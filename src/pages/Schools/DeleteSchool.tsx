...
import { DELETE_SCHOOL } from '../../graphql/mutations/School/deleteSchoolMutation';
import { GET_SCHOOLS } from '../../graphql/queries/School/getSchoolsQuery';

const DeleteSchool: React.FC<IDeleteModal & IModal> = ({id, close}) => {
    ...
    return (
        <main>
          ...
          <footer className="flex items-center justify-center p-2">
            <button
                onClick={() => deleteSchool({variables: {id: id}})}
