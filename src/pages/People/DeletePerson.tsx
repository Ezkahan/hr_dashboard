...
import { DELETE_PERSON } from '../../graphql/mutations/People/deletePersonMutation';

const DeletePerson: React.FC<IDeleteModal & IModal> = ({id, close}) => {
    ...
    const [deleteSkill] = useMutation(DELETE_PERSON, {
        onCompleted,
    ...
    return (
        <main>
          ...
          <footer className="flex items-center justify-center p-2">
            <button
                onClick={() => deleteSkill({variables: {id: id}})}
