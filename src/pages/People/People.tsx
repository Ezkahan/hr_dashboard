...
const People: React.FC = () => {
  ...
  const searchPeople = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        <main className="bg-white xl:px-8 px-6 xl:py-6 py-4 mb-5 rounded-lg">
          <header className=" flex justify-between items-center mb-5">
            <aside className="flex">
              ...
              <div className="flex flex-col">
                ...
                <small className="text-indigo-500">
                  {t("total")}:
                  <strong>{data?.people?.paginatorInfo?.total}</strong>
                </small>
              </div>
            </aside>
            ...
            <input
              ...
              className="border px-5 py-3 rounded-xl w-6/12"
            />
              ...
              <table className="w-full text-sm">
                <thead className="bg-slate-100 text-left text-gray-800">
                  <tr>
                    ...
                    <th className="px-4 py-3 w-20 xl:w-16 rounded-tr-lg rounded-br-lg">
                      {t("options")}
                    </th>
                  </tr>
                </thead>
                ...
                >
                  {data &&
                    data.people.data.map((person: any, index: number) => {
                      return (
                        <motion.tr
                          variants={tabVariant}
                          key={index}
