...
import { DELETE_TOWN } from "../../../graphql/mutations/Location/Town/deleteTownMutation";
import { GET_TOWNS } from "../../../graphql/queries/Location/Town/getTownsQuery";

const DeleteTown: React.FC<IDeleteModal & IModal> = ({id, close}) => {
    ...
    const [deleteTown] = useMutation(DELETE_TOWN, {
        onCompleted,
    ...
    return (
        <main>
          ...
          <footer className="flex items-center justify-center p-2">
            <button
                onClick={() => deleteTown({variables: {id: id}})}
