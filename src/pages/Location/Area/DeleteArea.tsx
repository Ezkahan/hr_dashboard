...
import { DELETE_AREA } from '../../../graphql/mutations/Location/Area/deleteAreaMutation';
import { GET_AREAS } from '../../../graphql/queries/Location/Area/getAreasQuery';

const DeleteArea: React.FC<IDeleteModal & IModal> = ({id, close}) => {
    ...
    return (
        <main>
          ...
          <footer className="flex items-center justify-center p-2">
            <button
                onClick={() => deleteArea({variables: {id: id}})}
